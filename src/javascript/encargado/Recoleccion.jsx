...
const Recoleccion = () => {
  ...
  const calcularLlenadoLitros = (capacidad, porcentaje) => {
                    ...
                    >
                      ...
                      <div className="card-center">
                        ...
                        <span className="badge-residuo" style={{ display: 'inline-block', background: '#e2e8f0', color: '#475569', padding: '4px 10px', borderRadius: '12px', fontSize: '0.75rem', marginBottom: '10px', fontWeight: '600' }}>
                          🗑️ {cont.conTipoResiduo?.treNombre || cont.tipoResiduo?.nombre || "Sin clasificar"}
                        </span>
                      ...
                      <div className="card-bottom">
                        <div className="progress-labels">
                          <span style={{ fontSize: '0.8rem', lineHeight: '1.4' }}>
                              Cap: {capacidadL} L <span className="text-muted">({capacidadKg} kg)</span>
                              <br/>
                              <small className="text-muted">Lleno: {llenoL} L <span style={{fontWeight: '600'}}>({llenoKg} kg)</span></small>
                          </span>
                          <span className={nivelPct > 80 ? 'text-danger fw-bold' : 'text-success fw-bold'}>
                            {nivelPct}%
                          </span>
                        </div>
