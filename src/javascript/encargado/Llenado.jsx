    ...
    const handleActualizar = async (e) => {
        ...
        try {
            ...
            await api.patch(`/contenedores/${contenedorId}/simular-sensor`, {
                pesoAgregado: parseFloat(formData.pesoAgregado),
                    ...
                    {step === 2 && (
                        <div className="step-2 animate-slide-up">
                            ...
                            <div className="action-row-left">
                                <button type="button" className="btn-back" onClick={handleBack}> {/* usa onClick={() => setStep(1)} en Llenado.jsx */}
                                    <ArrowLeftIcon />
                                    Volver a Facultades
                                </button>
                            </div>
                                    ...
                                    <div className="form-row-custom">
                                        <div className="form-group-r half">
                                            ...
                                            <div className="input-with-suffix">
                                                <input type="number" step="0.01" min="0.1" value={formData.pesoAgregado} onChange={e => setFormData({ ...formData, pesoAgregado: e.target.value })} required placeholder="Cantidad arrojada" />
